#
# Conditional build:
%bcond_with	vfmg	# use vfmg menu instead of autogenerated xfce menu
#
...
%lang(nl) %config(noreplace) %verify(not size mtime md5) %{_sysconfdir}/xdg/xfce4/desktop/menu.xml.pl
